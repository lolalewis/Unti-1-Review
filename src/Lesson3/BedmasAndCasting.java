...
public class BedmasAndCasting {
    ...
    public static void main(String[] args) {
        ...
        ans = e + f * g;   // 5 + 5 * 5
        System.out.format("%d + %d * %d =%d", e,f,g ,ans);  //30
        
        ans = (e + f) * g;   // (5 + 5) * 5
        System.out.format("(%d + %d) * %d =%d", e,f,g ,ans);  //50
        
        ans = e + f % g;   // 5 + 5 % 5 ->  5+0
        System.out.format("%d + %d %% %d =%d", e,f,g ,ans);  //5
        
        ans = (e + f) % g;   // (5 + 5) % 5 -> 10 % 5 -> 0
        System.out.format("(%d + %d) %% %d =%d", e,f,g ,ans);  //0
    }
